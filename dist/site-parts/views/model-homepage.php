            ...
            <div class="equation custom-grid">
                <div class="all-page-wrapper row">
                    <div class="animation square-border col custom-grid-item">
                        <h4 class="font-equation"><?= $dictionnaries[$_SESSION["locale"]]["homePageContent"]["formulas"]["value1"] ?></h4>
                    </div>

                    <div class="animation col custom-grid-item-small">
                        <h4 class="font-equation"> + </h4>
                    </div>
                    ...
                    -->
                    <div class="animation square-border col custom-grid-item">
                        <h4 class="font-equation"><?= $dictionnaries[$_SESSION["locale"]]["homePageContent"]["formulas"]["value2"] ?></h4>
                    </div>
                    ...
                    -->
                    <div class="animation square-border col custom-grid-item">
                        <h4 class="font-equation"><?= $dictionnaries[$_SESSION["locale"]]["homePageContent"]["formulas"]["value3"] ?></h4>
                    </div>
                </div>
            </div>
            <p class="font-description "><?=  $dictionnaries[$_SESSION["locale"]]["homePageContent"]["model"]["bloc1"]["content"]; ?></p>
